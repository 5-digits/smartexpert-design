...
$(document).ready(function() {
  ...
  var $table = $('#demo-custom-toolbar'),   $remove = $('#demo-delete-row2');
...
function star(value, row) {
    return '<div><span><i class="ion-ios-star"></i><i class="ion-ios-star"></i><i class="ion-ios-star"></i><i class="ion-ios-star-outline"></i><i class="ion-ios-star-outline"></i></span></div>';
}
